...
<html>
<head>
  <title>SEE Management Traffic</title>
...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>CBS SEE Management Traffic</h3>
      <div class="d-flex row">
      <div class="col-md-6 col-md">
          <?php $layoutRender->initChart('totalSuccessCBSSEEVoiceMGM', ChartAverageType::OneDay); ?>
        </div>
        <div class="col-md-6 col-md">
          <?php $layoutRender->initChart('totalFailedCBSSEEVoiceMGM', ChartAverageType::OneDay); ?>
        </div>
      </div>
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-6 col-md">
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSSEEVoiceMGMTehran', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSSEEVoiceMGMTabriz', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSSEEVoiceMGMShiraz', ChartAverageType::OneDay); ?> 
          </div> 
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSSEEVoiceMGMMashhad', ChartAverageType::OneDay); ?> 
          </div>    
        </div>
        <div class="col-md-6 col-md">
          <div>
              <?php $layoutRender->initChart('totalFailedCBSSEEVoiceMGMTehran', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalFailedCBSSEEVoiceMGMTabriz', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalFailedCBSSEEVoiceMGMShiraz', ChartAverageType::OneDay); ?> 
          </div> 
          <div>
              <?php $layoutRender->initChart('totalFailedCBSSEEVoiceMGMMashhad', ChartAverageType::OneDay); ?> 
          </div>   
        </div>
