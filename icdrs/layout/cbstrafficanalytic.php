...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>Traffic Analytic</h3>
      <div class="d-flex row">
        <div class="col-md-12 col-md">
          <?php $layoutRender->initChart('totalSuccessCBSSEEVoiceMOMT', ChartAverageType::OneDay); ?>
        </div>
        <div class="col-md-12 col-md">
          <?php $layoutRender->initChart('totalSuccessCBSSEEVoiceMOMT-analytic', ChartAverageType::OneDay); ?>      
        </div> 
        <div class="col-md-12 col-md">
          <?php $layoutRender->initChart('totalSuccessCBSCBPData', ChartAverageType::OneDay); ?>
        </div>
        <div class="col-md-12 col-md">
          <?php $layoutRender->initChart('totalSuccessCBSCBPData-analytic', ChartAverageType::OneDay); ?>      
        </div>
      </div>  
