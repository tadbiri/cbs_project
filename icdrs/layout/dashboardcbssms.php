...
<div class="container">
  <div class="chart-main-box-db">
    <h3 class='chart-title-db'>CBS SMS</h3>
      ...
      <div class="d-flex row row-db">
        ...
        <h3 class="chart-title-db-2">Tehran</h3>
          <div class="d-flex row">
            <div class="col-md-6 col-md-db">
              <?php $layoutRender->initChart('totalSuccessCBSCBPSMS', ChartAverageType::OneDay); ?>
            </div>
            <div class="col-md-6 col-md-db">
              <?php $layoutRender->initChart('totalSuccessCBSCBPSMS', ChartAverageType::TwoHour); ?>
            </div>
          </div>
          <div class="d-flex row">
            <div class="col-md-6 col-md-db">
              <?php $layoutRender->initChart('totalFailedCBSCBPSMS', ChartAverageType::OneDay); ?>
            </div>
            <div class="col-md-6 col-md-db">
              <?php $layoutRender->initChart('totalFailedCBSCBPSMS', ChartAverageType::TwoHour); ?>
            </div>
          </div>
          <div class="d-flex row">
            <div class="col-md-6 col-md-db">
            ...
            <div class="col-md-6 col-md-db">
              <?php $layoutRender->initChart('totalSuccessRateCBSCBPSMS', ChartAverageType::TwoHour); ?>
            </div>
          </div>
        </div>  
