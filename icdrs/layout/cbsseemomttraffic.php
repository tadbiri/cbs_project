...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>CBS SEE MO/MT Traffic</h3>
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-6 col-md">
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSSEEVoiceMOMTTehran', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSSEEVoiceMOMTTabriz', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSSEEVoiceMOMTShiraz', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSSEEVoiceMOMTMashhad', ChartAverageType::OneDay); ?> 
          </div>    
        </div>

        <div class="col-md-6 col-md">
            <div>
              <?php $layoutRender->initChart('totalFailedCBSSEEVoiceMOMTTehran', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalFailedCBSSEEVoiceMOMTTabriz', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalFailedCBSSEEVoiceMOMTShiraz', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalFailedCBSSEEVoiceMOMTMashhad', ChartAverageType::OneDay); ?> 
            </div>      
        </div> 
      </div> 
