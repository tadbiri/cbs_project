...
<html>
<head>
  <title>Tabriz SEE MO/MT Error</title>
...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>Tabriz SEE MO/MT Error</h3>
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTabrizsee1', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTabrizsee2', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTabrizsee3', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTabrizsee4', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTabrizsee5', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTabrizsee6', ChartAverageType::OneDay); ?> 
        </div>   
      </div> 
