...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>CBS CBP Data Traffic</h3>
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-6 col-md">
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSCBPDataTehran', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSCBPDataTabriz', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSCBPDataShiraz', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSCBPDataMashhad', ChartAverageType::OneDay); ?> 
          </div>    
        </div>

        <div class="col-md-6 col-md">
            <div>
              <?php $layoutRender->initChart('totalFailedCBSCBPDataTehran', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalFailedCBSCBPDataTabriz', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalFailedCBSCBPDataShiraz', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalFailedCBSCBPDataMashhad', ChartAverageType::OneDay); ?> 
            </div>      
        </div> 
      </div> 
