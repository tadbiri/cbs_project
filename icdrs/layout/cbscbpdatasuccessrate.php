...
<html>
<head>
  <title>CBS Data Success Rate</title>
...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>CBS Data Success Rate</h3>
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-6 col-md">
          <div>
              <?php $layoutRender->initChart('totalSuccessRateCBSCBPDataTehran', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessRateCBSCBPDataShiraz', ChartAverageType::OneDay); ?> 
          </div>  
        </div>

        <div class="col-md-6 col-md">
            <div>
              <?php $layoutRender->initChart('totalSuccessRateCBSCBPDataTabriz', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalSuccessRateCBSCBPDataMashhad', ChartAverageType::OneDay); ?> 
            </div>   
        </div> 
      </div> 
