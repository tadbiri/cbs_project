...
<html>
<head>
  <title>SEE MO/MT Success Rate</title>
...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>CBS SEE MO/MT Success Rate</h3>
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-6 col-md">
          <div>
              <?php $layoutRender->initChart('totalSuccessRateCBSSEEVoiceMOMTTehran', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessRateCBSSEEVoiceMOMTShiraz', ChartAverageType::OneDay); ?> 
          </div>  
        </div>

        <div class="col-md-6 col-md">
            <div>
              <?php $layoutRender->initChart('totalSuccessRateCBSSEEVoiceMOMTTabriz', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalSuccessRateCBSSEEVoiceMOMTMashhad', ChartAverageType::OneDay); ?> 
            </div>   
        </div> 
      </div> 
