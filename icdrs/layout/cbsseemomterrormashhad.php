...
<html>
<head>
  <title>Mashhad SEE MO/MT Error</title>
...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>Mashhad SEE MO/MT Error</h3>
       
      <hr class="bold-hr">
    
      <div class="d-flex row">
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTMashhadsee1', ChartAverageType::OneDay); ?> 
        </div>
      </div>

      <div class="d-flex row">
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTMashhadsee2', ChartAverageType::OneDay); ?> 
        </div>
      </div>

      <div class="d-flex row">
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTMashhadsee3', ChartAverageType::OneDay); ?> 
        </div>
      </div>

      <div class="d-flex row">
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTMashhadsee4', ChartAverageType::OneDay); ?> 
        </div>
      </div>

      <div class="d-flex row">
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTMashhadsee5', ChartAverageType::OneDay); ?> 
        </div>
      </div>

      <div class="d-flex row">
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTMashhadsee6', ChartAverageType::OneDay); ?> 
        </div>   
      </div> 
