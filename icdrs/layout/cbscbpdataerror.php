...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>CBS Data Error</h3>
      <div class="d-flex row">
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSCBPData', ChartAverageType::OneDay); ?>
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-6">
          <div>
              <?php $layoutRender->initChart('totalErrorCBSCBPDataTehran', ChartAverageType::OneDay); ?> 
              <div class="check-detail">
              <a href='http://10.15.90.200/icdr/layout/cbscbpdataerror.php'>
                <button class='button_link'>Analyze per CBP</button>
             </a></div>
         </div>
         <div>
             <?php $layoutRender->initChart('totalErrorCBSCBPDataShiraz', ChartAverageType::OneDay); ?> 
             <div class="check-detail">
             <a href='http://10.15.90.200/icdr/layout/cbscbpdataerror.php'>
                <button class='button_link'>Analyze per CBP</button>
             </a></div>
       ...
       <div class="col-md-6">
           <div>
             <?php $layoutRender->initChart('totalErrorCBSCBPDataTabriz', ChartAverageType::OneDay); ?> 
             <div class="check-detail">
             <a href='http://10.15.90.200/icdr/layout/cbscbpdataerror.php'>
                <button class='button_link'>Analyze per CBP</button>
             </a></div>
           ...
           <div>
             <?php $layoutRender->initChart('totalErrorCBSCBPDataMashhad', ChartAverageType::OneDay); ?> 
             <div class="check-detail">
             <a href="http://10.15.90.200/icdr/layout/cbscbpdataerror.php">
                <button class='button_link'>Analyze per CBP</button>
             </a></div>
