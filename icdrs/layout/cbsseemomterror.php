...
<head>
  ...
  <script src="/icdr/config/grapherror.js"></script>
...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>CBS SEE MO/MT Error</h3>
      <div class="d-flex row">
        <div class="col-md-12 col-md">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMT', ChartAverageType::OneDay); ?>
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-6 col-md">
          <div>
              <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTehran', ChartAverageType::OneDay); ?> 
              <div class="check-detail">
              <a href='http://10.15.90.200/icdr/layout/cbsseemomterrortehran.php'>
                <button class='button_link'>Analyze per SEE</button>
             </a></div>
         </div>
         <div>
             <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTShiraz', ChartAverageType::OneDay); ?> 
             <div class="check-detail">
             <a href='http://10.15.90.200/icdr/layout/cbsseemomterrorshiraz.php'>
                <button class='button_link'>Analyze per SEE</button>
             </a></div>
         </div>   
       </div>
       <div class="col-md-6 col-md">
           <div>
             <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTabriz', ChartAverageType::OneDay); ?> 
             <div class="check-detail">
             <a href='http://10.15.90.200/icdr/layout/cbsseemomterrortabriz.php'>
                <button class='button_link'>Analyze per SEE</button>
             </a></div>
           </div>
           <div>
             <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTMashhad', ChartAverageType::OneDay); ?> 
             <div class="check-detail">
             <a href="http://10.15.90.200/icdr/layout/cbsseemomterrormashhad.php">
                <button class='button_link'>Analyze per SEE</button>
             </a></div>
            </div>      
        </div> 
