...
<html>
<head>
  <title>CBS Call Type Traffic</title>
...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>CBS Call Type Traffic</h3>
      <div class="d-flex row">
        <div class="col-md-6 col-md">
          <?php $layoutRender->initChart('totalSuccessCBSSEERecCallType', ChartAverageType::OneDay); ?>
        </div>
        <div class="col-md-6 col-md">
          <?php $layoutRender->initChart('totalFailedCBSSEERecCallType', ChartAverageType::OneDay); ?>      
        </div> 
      </div>  
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-6 col-md">
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSSEERecCallTypeTehran', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSSEERecCallTypeTabriz', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSSEERecCallTypeShiraz', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSSEERecCallTypeMashhad', ChartAverageType::OneDay); ?> 
          </div>    
        </div>

        <div class="col-md-6 col-md">
            <div>
              <?php $layoutRender->initChart('totalFailedCBSSEERecCallTypeTehran', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalFailedCBSSEERecCallTypeTabriz', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalFailedCBSSEERecCallTypeShiraz', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalFailedCBSSEERecCallTypeMashhad', ChartAverageType::OneDay); ?> 
            </div>      
        </div> 
      </div> 
