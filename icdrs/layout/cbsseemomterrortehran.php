...
<html>
<head>
  <title>Tehran SEE MO/MT Error</title>
...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>Tehran SEE MO/MT Error</h3>
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTehransee1', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTehransee2', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTehransee3', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTehransee4', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTehransee5', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTTehransee6', ChartAverageType::OneDay); ?> 
        </div>   
      </div> 
