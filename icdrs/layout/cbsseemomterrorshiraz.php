...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>Shiraz SEE MO/MT Error</h3>
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTShirazsee1', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTShirazsee2', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTShirazsee3', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTShirazsee4', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTShirazsee5', ChartAverageType::OneDay); ?> 
        </div>
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSSEEVoiceMOMTShirazsee6', ChartAverageType::OneDay); ?> 
        </div>   
      </div> 
