...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>CBS SMS Error</h3>
      <div class="d-flex row">
        <div class="col-md-12">
          <?php $layoutRender->initChart('totalErrorCBSCBPSMS', ChartAverageType::OneDay); ?>
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-6">
          <div>
              <?php $layoutRender->initChart('totalErrorCBSCBPSMSTehran', ChartAverageType::OneDay); ?> 
         ...
         <div>
             <?php $layoutRender->initChart('totalErrorCBSCBPSMSShiraz', ChartAverageType::OneDay); ?> 
             <div class="check-detail">
             <a href='http://10.15.90.200/icdr/layout/cbscbpsmserror.php'>
                <button class='button_link'>Analyze per CBP</button>
             </a></div>
       ...
       <div class="col-md-6">
           <div>
             <?php $layoutRender->initChart('totalErrorCBSCBPSMSTabriz', ChartAverageType::OneDay); ?> 
             <div class="check-detail">
             <a href='http://10.15.90.200/icdr/layout/cbscbpsmserror.php'>
                <button class='button_link'>Analyze per CBP</button>
             </a></div>
           ...
           <div>
             <?php $layoutRender->initChart('totalErrorCBSCBPSMSMashhad', ChartAverageType::OneDay); ?> 
             <div class="check-detail">
             <a href="http://10.15.90.200/icdr/layout/cbscbpsmserror.php">
                <button class='button_link'>Analyze per CBP</button>
             </a></div>
