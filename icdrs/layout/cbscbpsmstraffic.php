...
<div class="container">
    <div class="chart-main-box">
      <h3 class='chart-title'>CBS CBP SMS Traffic</h3>
    ...
    <hr class="bold-hr">
      ...
      <div class="d-flex row">
        <div class="col-md-6 col-md">
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSCBPSMSTehran', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSCBPSMSTabriz', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSCBPSMSShiraz', ChartAverageType::OneDay); ?> 
          </div>
          <div>
              <?php $layoutRender->initChart('totalSuccessCBSCBPSMSMashhad', ChartAverageType::OneDay); ?> 
          </div>    
        </div>

        <div class="col-md-6 col-md">
            <div>
              <?php $layoutRender->initChart('totalFailedCBSCBPSMSTehran', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalFailedCBSCBPSMSTabriz', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalFailedCBSCBPSMSShiraz', ChartAverageType::OneDay); ?> 
            </div>
            <div>
              <?php $layoutRender->initChart('totalFailedCBSCBPSMSMashhad', ChartAverageType::OneDay); ?> 
            </div>      
        </div> 
      </div> 
