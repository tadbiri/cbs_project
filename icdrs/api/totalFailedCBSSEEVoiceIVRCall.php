...
class totalFailedCBSSEEVoiceIVRCall extends Chart{
    public function __construct(){
        // Initial chartName
        $this->chartName = strtolower(__CLASS__);
        
        $this->chartTitle = 'Total IVR-Call Failed';
        ...
        $this->entities = [
            ['label'=>'Tehran', 'colorCode'=>'FF0000', 'param'=>['region_id'=>'1'], 'description'=>'Tehran Total IVRCall Failed'],
            ['label'=>'Tabriz', 'colorCode'=>'0000FF', 'param'=>['region_id'=>'2'], 'description'=>'Tabriz Total IVRCall Failed'],
            ['label'=>'Shiraz', 'colorCode'=>'176b2a', 'param'=>['region_id'=>'3'], 'description'=>'Shiraz Total IVRCall Failed'],
            ['label'=>'Mashhad', 'colorCode'=>'dbbb18', 'param'=>['region_id'=>'4'], 'description'=>'Mashhad Total IVRCall Failed']
        ];
    }
}
