...
class CBSCBPDataCellProvinceAmount extends Chart{
    public function __construct(){
        // Initial chartName
        $this->chartName = strtolower(__CLASS__);
        
        $this->chartTitle = 'Total Province Data Amount';
        ...
        $this->query = "set statement_timeout= '600000s';
                        SELECT to_char(cdr_date_time, 'YYYY-MM-DD HH24:MI') AS \"dateTime\", (SUM(debit_amount)+(sum(free_amount)/2.7))/10 AS \"errorCount\"
