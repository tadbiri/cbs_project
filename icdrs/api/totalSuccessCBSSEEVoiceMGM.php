...
class totalSuccessCBSSEEVoiceMGM extends Chart{
    public function __construct(){
        // Initial chartName
        $this->chartName = strtolower(__CLASS__);
        
        $this->chartTitle = 'Total Management Success';
        ...
        $this->entities = [
            ['label'=>'Tehran', 'colorCode'=>'FF0000', 'param'=>['region_id'=>'1'], 'description'=>'Tehran Total MGM Success'],
            ['label'=>'Tabriz', 'colorCode'=>'0000FF', 'param'=>['region_id'=>'2'], 'description'=>'Tabriz Total MGM Success'],
            ['label'=>'Shiraz', 'colorCode'=>'176b2a', 'param'=>['region_id'=>'3'], 'description'=>'Shiraz Total MGM Success'],
            ['label'=>'Mashhad', 'colorCode'=>'dbbb18', 'param'=>['region_id'=>'4'], 'description'=>'Mashhad Total MGM Success']
        ];
    }
}
