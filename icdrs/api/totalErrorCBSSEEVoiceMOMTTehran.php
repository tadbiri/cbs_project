...
class totalErrorCBSSEEVoiceMOMTTehran extends Chart{
    public function __construct(){
        // Initial chartName
        $this->chartName = strtolower(__CLASS__);

        $this->chartTitle = 'Total Error Tehran';

        $this->chartDetail = 'http://10.15.90.200/icdr/cbs/see/voice/momt/errorchart/layout/totalerrortehran.php';

        $this->chartLengendHeightPerPixel = 140;
