...
class totalSuccessCBSSEEVoiceMGMTabriz extends Chart{
    public function __construct(){
        // Initial chartName
        $this->chartName = strtolower(__CLASS__);
        
        $this->chartTitle = 'Total Management Success Tabriz';
        ...
        $this->entities = [
            ['label'=>'tsee1', 'colorCode'=>'4165f5', 'param'=>['see_id'=>'7'],'description'=>'Tabriz SEE1 Total MGM Success'],
            ['label'=>'tsee2', 'colorCode'=>'e4532f', 'param'=>['see_id'=>'8'],'description'=>'Tabriz SEE2 Total MGM Success'],
            ['label'=>'tsee3', 'colorCode'=>'67ac11', 'param'=>['see_id'=>'9'],'description'=>'Tabriz SEE3 Total MGM Success'],
            ['label'=>'tsee4', 'colorCode'=>'c30f00', 'param'=>['see_id'=>'10'],'description'=>'Tabriz SEE4 Total MGM Success'],
            ['label'=>'tsee5', 'colorCode'=>'dbbb18', 'param'=>['see_id'=>'11'],'description'=>'Tabriz SEE5 Total MGM Success'],
            ['label'=>'tsee6', 'colorCode'=>'9123bc', 'param'=>['see_id'=>'12'],'description'=>'Tabriz SEE6 Total MGM Success']
        ];
    }
}