...
class totalFailedCBSSEEVoiceIVRCallMashhad extends Chart{
    public function __construct(){
        // Initial chartName
        $this->chartName = strtolower(__CLASS__);
        
        $this->chartTitle = 'Total IVR-Call Failed Mashhad';
        ...
        $this->entities = [
            ['label'=>'msee1', 'colorCode'=>'4165f5', 'param'=>['see_id'=>'19'],'description'=>'Mashhad SEE1 Total IVRCall Failed'],
            ['label'=>'msee2', 'colorCode'=>'e4532f', 'param'=>['see_id'=>'20'],'description'=>'Mashhad SEE2 Total IVRCall Failed'],
            ['label'=>'msee3', 'colorCode'=>'67ac11', 'param'=>['see_id'=>'21'],'description'=>'Mashhad SEE3 Total IVRCall Failed'],
            ['label'=>'msee4', 'colorCode'=>'c30f00', 'param'=>['see_id'=>'22'],'description'=>'Mashhad SEE4 Total IVRCall Failed'],
            ['label'=>'msee5', 'colorCode'=>'dbbb18', 'param'=>['see_id'=>'23'],'description'=>'Mashhad SEE5 Total IVRCall Failed'],
            ['label'=>'msee6', 'colorCode'=>'9123bc', 'param'=>['see_id'=>'24'],'description'=>'Mashhad SEE6 Total IVRCall Failed']
        ];
    }
}
