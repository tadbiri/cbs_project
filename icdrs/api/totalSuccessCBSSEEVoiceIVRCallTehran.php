...
class totalSuccessCBSSEEVoiceIVRCallTehran extends Chart{
    public function __construct(){
        // Initial chartName
        $this->chartName = strtolower(__CLASS__);
        
        $this->chartTitle = 'Total IVR-Call Success Tehran';
        ...
        $this->entities = [
            ['label'=>'see1', 'colorCode'=>'4165f5', 'param'=>['see_id'=>'1'],'description'=>'Tehran SEE1 Total IVRCall Success'],
            ['label'=>'see2', 'colorCode'=>'e4532f', 'param'=>['see_id'=>'2'],'description'=>'Tehran SEE2 Total IVRCall Success'],
            ['label'=>'see3', 'colorCode'=>'67ac11', 'param'=>['see_id'=>'3'],'description'=>'Tehran SEE3 Total IVRCall Success'],
            ['label'=>'see4', 'colorCode'=>'c30f00', 'param'=>['see_id'=>'4'],'description'=>'Tehran SEE4 Total IVRCall Success'],
            ['label'=>'see5', 'colorCode'=>'dbbb18', 'param'=>['see_id'=>'5'],'description'=>'Tehran SEE5 Total IVRCall Success'],
            ['label'=>'see6', 'colorCode'=>'9123bc', 'param'=>['see_id'=>'6'],'description'=>'Tehran SEE6 Total IVRCall Success']
        ];
    }
}
