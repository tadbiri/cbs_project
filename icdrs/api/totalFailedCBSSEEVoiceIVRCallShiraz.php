...
class totalFailedCBSSEEVoiceIVRCallShiraz extends Chart{
    public function __construct(){
        // Initial chartName
        $this->chartName = strtolower(__CLASS__);
        
        $this->chartTitle = 'Total IVR-Call Failed Shiraz';
        ...
        $this->entities = [
            ['label'=>'ssee1', 'colorCode'=>'4165f5', 'param'=>['see_id'=>'13'],'description'=>'Shiraz SEE1 Total IVRCall Failed'],
            ['label'=>'ssee2', 'colorCode'=>'e4532f', 'param'=>['see_id'=>'14'],'description'=>'Shiraz SEE2 Total IVRCall Failed'],
            ['label'=>'ssee3', 'colorCode'=>'67ac11', 'param'=>['see_id'=>'15'],'description'=>'Shiraz SEE3 Total IVRCall Failed'],
            ['label'=>'ssee4', 'colorCode'=>'c30f00', 'param'=>['see_id'=>'16'],'description'=>'Shiraz SEE4 Total IVRCall Failed'],
            ['label'=>'ssee5', 'colorCode'=>'dbbb18', 'param'=>['see_id'=>'17'],'description'=>'Shiraz SEE5 Total IVRCall Failed'],
            ['label'=>'ssee6', 'colorCode'=>'9123bc', 'param'=>['see_id'=>'18'],'description'=>'Shiraz SEE6 Total IVRCall Failed']
        ];
    }
}