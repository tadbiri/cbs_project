...
//$cityList = getDirList('/cbshome/cdr_analysis/data/cbs/cbp/data/tabriz');
$city = '/cbshome/cdr_analysis/data/cbs/cbp/data/tabriz';
while(true) {
    //foreach($cityList as $city){
        ...
        foreach($dateDirList as $dateDir){
            ...
            foreach($fileList as $file){
                ...
                $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbp/data/tabriz.log";
                $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbp/data/error_tabriz_data.log";
                if (!is_dir($logFile)) {
