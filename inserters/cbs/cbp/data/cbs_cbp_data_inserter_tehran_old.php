...
//$cityList = getDirList('/cbshome/cdr_analysis/data/cbs/cbp/data/tehran');
$city = '/cbshome/cdr_analysis/data/cbs/cbp/data/tehran';
while(true) {
    //foreach($cityList as $city){
        ...
        foreach($dateDirList as $dateDir){
            ...
            foreach($fileList as $file){
                ...
                $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbp/data/tehran.log";
                $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbp/data/error_tehran_data.log";
                if (!is_dir($logFile)) {
