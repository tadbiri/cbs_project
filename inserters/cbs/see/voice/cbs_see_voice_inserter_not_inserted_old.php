...
$city = '/cbshome/cdr_analysis/data/cbs/see/voice/not-inserted';
while(true) {
       ...
       $dateDirList = getDirList($city);
        ...
        foreach($dateDirList as $dateDir){
            ...
            foreach($fileList as $file){
                ...
                $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/see/voice/not_inserted.log";
                $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/see/voice/error_not_inserted_voice.log";
                if (!is_dir($logFile)) {
