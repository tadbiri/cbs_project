...
$city = '/cbshome/cdr_analysis/data/cbs/see/voice/mashhad';
while(true) {
       ...
       $dateDirList = getDirList($city);
        ...
        foreach($dateDirList as $dateDir){
            ...
            foreach($fileList as $file){
                ...
                $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/see/voice/mashhad.log";
                $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/see/voice/error_mashhad_voice.log";
                if (!is_dir($logFile)) {
