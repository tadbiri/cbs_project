...
$city = '/cbshome/cdr_analysis/data/cbs/see/voice/tehran';
while(true) {
   ...
   ;
            ...
            foreach($fileList as $file){
                ...
                $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/see/voice/tehran.log";
                $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/see/voice/error_tehran_voice.log";
                if (!is_dir($logFile)) {
