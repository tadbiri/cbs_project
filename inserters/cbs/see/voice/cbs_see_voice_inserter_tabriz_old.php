...
$city = '/cbshome/cdr_analysis/data/cbs/see/voice/tabriz';
while(true) {
       ...
       $dateDirList = getDirList($city);
        ...
        foreach($dateDirList as $dateDir){
            ...
            foreach($fileList as $file){
                ...
                $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/see/voice/tabriz.log";
                $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/see/voice/error_tabriz_voice.log";
                if (!is_dir($logFile)) {
