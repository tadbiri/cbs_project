...
$city = '/cbshome/cdr_analysis/data/cbs/see/rec/shiraz';
while(true) {
    //foreach($cityList as $city){
        ...
        foreach($dateDirList as $dateDir){
            ...
            foreach($fileList as $file){
                ...
                $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/see/rec/shiraz.log";
                $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/see/rec/error_shiraz_rec.log";
                if (!is_dir($logFile)) {
