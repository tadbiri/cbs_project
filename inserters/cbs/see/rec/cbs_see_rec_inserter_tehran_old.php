...
$city = '/cbshome/cdr_analysis/data/cbs/see/rec/tehran';
while(true) {
    //foreach($cityList as $city){
        ...
        foreach($dateDirList as $dateDir){
            ...
            foreach($fileList as $file){
                ...
                $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/see/rec/tehran.log";
                $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/see/rec/error_tehran_rec.log";
                if (!is_dir($logFile)) {
