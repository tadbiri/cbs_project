...
$city = '/cbshome/cdr_analysis/data/cbs/cbpadapter/voice/shiraz/scbpa1';
while(true) {
    ...
    foreach($fileList as $file){
        ...
        $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/voice/scbpa1.log";
        $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/voice/error_scbpa1_voice.log";
        if (!is_dir($logFile)) {
