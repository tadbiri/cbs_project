...
$city = '/cbshome/cdr_analysis/data/cbs/cbpadapter/voice/tehran/cbpa2';
while(true) {
    ...
    foreach($fileList as $file){
        ...
        $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/voice/cbpa2.log";
        $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/voice/error_cbpa2_voice.log";
        if (!is_dir($logFile)) {
