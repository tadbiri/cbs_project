...
$city = '/cbshome/cdr_analysis/data/cbs/cbpadapter/voice/tabriz/tcbpa2';
while(true) {
    ...
    foreach($fileList as $file){
        ...
        $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/voice/tcbpa2.log";
        $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/voice/error_tcbpa2_voice.log";
        if (!is_dir($logFile)) {
