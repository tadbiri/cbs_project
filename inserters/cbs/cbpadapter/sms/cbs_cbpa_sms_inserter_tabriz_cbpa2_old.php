...
$city = '/cbshome/cdr_analysis/data/cbs/cbpadapter/sms/tabriz/tcbpa2';
while(true) {
    ...
    foreach($fileList as $file){
        ...
        $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/sms/tcbpa2.log";
        $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/sms/error_tcbpa2_sms.log";
        if (!is_dir($logFile)) {
