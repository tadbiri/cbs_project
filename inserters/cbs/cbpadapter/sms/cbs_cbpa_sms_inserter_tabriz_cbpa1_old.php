...
$city = '/cbshome/cdr_analysis/data/cbs/cbpadapter/sms/tabriz/tcbpa1';
while(true) {
    ...
    foreach($fileList as $file){
        ...
        $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/sms/tcbpa1.log";
        $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/sms/error_tcbpa1_sms.log";
        if (!is_dir($logFile)) {
