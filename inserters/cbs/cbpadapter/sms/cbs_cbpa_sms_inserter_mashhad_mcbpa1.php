...
define('FEED_LOG_DIR', "/cbshome/cdr_analysis/data/cbs/cbpadapter/sms/mashhad/mcbpa1");
    ...
    //foreach($cityList as $city){
        ...
        //foreach($dateDirList as $dateDir){
            ...
            foreach($fileList as $file){
                ...
                $insertTupleCSV = rtrim($insertTupleCSV, ",");
                $sql = "INSERT INTO cbs_cbpa_sms_log VALUES $insertTupleCSV 
                ON CONFLICT ON CONSTRAINT cbs_cbpa_sms_log_uniq_cons DO UPDATE
