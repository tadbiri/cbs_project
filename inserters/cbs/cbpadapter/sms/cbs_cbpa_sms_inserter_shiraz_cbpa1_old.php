...
$city = '/cbshome/cdr_analysis/data/cbs/cbpadapter/sms/shiraz/scbpa1';
while(true) {
    ...
    foreach($fileList as $file){
        ...
        $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/sms/scbpa1.log";
        $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/sms/error_scbpa1_sms.log";
        if (!is_dir($logFile)) {
