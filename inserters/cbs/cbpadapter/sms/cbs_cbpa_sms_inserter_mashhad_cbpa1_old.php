...
$city = '/cbshome/cdr_analysis/data/cbs/cbpadapter/sms/mashhad/mcbpa1';
while(true) {
    ...
    foreach($fileList as $file){
        ...
        $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/sms/mcbpa1.log";
        $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/sms/error_mcbpa1_sms.log";
        if (!is_dir($logFile)) {
