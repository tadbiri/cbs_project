...
$city = '/cbshome/cdr_analysis/data/cbs/cbpadapter/data/tehran/cbpa2';
while(true) { 
    ...
    foreach($fileList as $file){
        ...
        $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/data/cbpa2.log";
        $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/data/error_cbpa2_data.log";
        if (!is_dir($logFile)) {
