...
$city = '/cbshome/cdr_analysis/data/cbs/cbpadapter/data/shiraz/scbpa2';
while(true) {
    ...
    foreach($fileList as $file){
        ...
        $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/data/scbpa2.log";
        $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/data/error_scbpa2_data.log";
        if (!is_dir($logFile)) {
