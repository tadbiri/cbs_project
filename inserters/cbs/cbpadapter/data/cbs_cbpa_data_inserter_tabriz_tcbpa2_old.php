...
$city = '/cbshome/cdr_analysis/data/cbs/cbpadapter/data/tabriz/tcbpa2';
while(true) {
    ...
    foreach($fileList as $file){
        ...
        $logFile = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/data/tcbpa2.log";
        $errorLog = "/cbshome/cdr_analysis/app/cdr_db_inserter/cbs/cbpadapter/data/error_tcbpa2_data.log";
        if (!is_dir($logFile)) {
